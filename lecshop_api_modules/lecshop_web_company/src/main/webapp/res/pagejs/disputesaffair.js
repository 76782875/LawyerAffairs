                ...
                for (var i = 0; i < res.data.length; i++) {
                    ...
                    if (pageNum === 0 && (i === 0 || i === 1 || i === 2)) {
                        html += '<div class="panel lawyer_mian"> ' +
                            ...
                            '                                <button type="button" class="btn btn-info" onclick="disputes(' + lawyerId + ')"><i class="icon-external-link"></i> 发起委托 </button>' +
                            '                            </div> ' +
                            '                        </div> ' +
                        ...
                        htmls += '<div class="col-md-4 col-sm-6">' +
                            ...
                            '                                        <button type="button" class="btn btn-info" onclick="disputes(' + lawyerId + ')"><i class="icon-external-link"></i> 委托</button>' +
                            '                                    </div>' +
                            '                                </div>' +
                            '                            </div>' +
                            '                        </div>' +
...
function toPastCases(id, name, institution) {
    var code = id === null ? "" : id;
    window.location.href = basePath + "c_topastcases.htm" + "?code=" + code + "&name=" + name + "&institution=" + institution + "&type=" + 2;
}
...
function disputesSave() {
    ...
    LSFetch({
        url: basePath + '/c_adddisputes.htm',
