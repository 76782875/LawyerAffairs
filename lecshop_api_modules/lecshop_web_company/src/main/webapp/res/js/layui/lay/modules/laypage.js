  ...
  return a.attachEvent ? a.attachEvent("on" + t,
     ...
     p.prototype.view = function() {
      var a = this,
          ...
          e = [],
          r = {};
      if (t.pages = 0 | t.pages, t.curr = 0 | t.curr || 1, t.groups = "groups" in t ? 0 | t.groups: 5, t.first = "first" in t ? t.first: "&#x9996;&#x9875;", t.last = "last" in t ? t.last: "&#x672B;&#x9875;", t.prev = "prev" in t ? t.prev: "&#x4E0A;&#x4E00;&#x9875;", t.next = "next" in t ? t.next: "&#x4E0B;&#x4E00;&#x9875;", t.pages <= 1) return '<div class="layui-box layui-laypage layui-laypage-molv" id="layui-laypage-0"><span class="layui-laypage-prev">&lt;</span><span class="layui-laypage-curr"><em class="layui-laypage-em"></em><em>1</em></span><span class="layui-laypage-nomore" title="已没有更多">&gt;</span></div>';
      for (t.groups > t.pages && (t.groups = t.pages), r.index = Math.ceil((t.curr + (t.groups > 1 && t.groups !== t.pages ? 1 : 0)) / (0 === t.groups ? 1 : t.groups)),
           t.prev && (t.curr === 1?e.push('<span class="layui-laypage-prev">' + t.prev + "</span>"):e.push('<a href="javascript:;" class="layui-laypage-prev" data-page="' + (t.curr - 1) + '">' + t.prev + "</a>")),
      ...
      (t.next || r.flow) && e.push(function() {
       if (t.curr === t.pages) {
        return '<span class="layui-laypage-nomore" title="&#x5DF2;&#x6CA1;&#x6709;&#x66F4;&#x591A;">' + t.next + '</span>';
       }
      ...
      function() {
       return t.skip ? '<span class="layui-laypage-total">&#x5230;&#x7B2C; <input type="text" min="1" onkeyup="this.value=this.value.replace(/\\D/, \'\');" value="' + t.curr + '" class="layui-laypage-skip"> &#x9875; <button type="button" class="layui-laypage-btn">&#x786e;&#x5b9a;</button></span>': ""
      } () + "</div>"
     },
