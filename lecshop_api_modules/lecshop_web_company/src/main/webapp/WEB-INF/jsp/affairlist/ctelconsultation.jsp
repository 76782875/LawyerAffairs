                        ...
                        <div class="panel-body">
                            ...
                            <header class="panel-heading tab-bg-dark-navy-blue ">
                                <ul class="nav nav-tabs">
                                    <li class="active"><a onclick="changeTables(0)" style="cursor: pointer;">电话咨询</a></li>
                                    <li><a onclick="changeTables(2)" style="cursor: pointer;">预约会面</a></li>
...
<div class="modal fade" id="confirm_dialog">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">确定要确认该电话咨询吗？</div>
            <div class="modal-footer">
                <button data-dismiss="modal" class="btn btn-default" type="button">取消</button>
                <button class="btn btn-success" type="button" onclick="confirm()">确定</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="<%=basePath %>/res/pagejs/ctelconsultation.js"></script>
</body>
</html>
