                        ...
                        <div class="panel-body">
                            ...
                            <header class="panel-heading tab-bg-dark-navy-blue ">
                                <ul class="nav nav-tabs">
                                    <li><a onclick="changeTables(0,this)" style="cursor: pointer;">律师函</a></li>
                                    <li <c:if test="${url eq 'c_querydraftdoc'}">class="active"</c:if>><a onclick="changeTables(1,this)" style="cursor: pointer;">草拟文书</a></li>
                                    <li <c:if test="${url eq 'c_querymodifydoc'}">class="active"</c:if>><a onclick="changeTables(2,this)" style="cursor: pointer;">修改文书</a></li>
                                </ul>
                            </header>
                            <div class="panel-body">
...
<div class="modal fade" id="confirm_dialog">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">确定要确认该文书吗？</div>
...
<div class="modal fade" id="score_dialog">
    <input type="hidden" id="scoreDocId"/>
...
<div class="modal fade" id="communion_dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">文书交流</h4>
            </div>
            <div class="modal-body">
                <div class="form-horizontal tasi-form">
                    <iframe name="fileIframe" style="display:none"></iframe>
                    <form enctype="multipart/form-data" method="post" id="fileForm" target="fileIframe">
...
<script type="text/javascript" src="<%=basePath%>/res/pagejs/modifyanddraftdoc.js"></script>
</body>
</html>
