package com.lecshop.company.kaptcha;
...
public class KaptchaController extends KaptchaUtil {
     ...
     * 生成验证码
     */
    @RequestMapping("/c_createkaptcha")
    @UnAuth
    public void createKaptcha(HttpServletResponse response, HttpServletRequest request) throws Exception {
        super.createKaptcha(response, code -> request.getSession().setAttribute(CommonConstant.COMPANY_LOGIN_KAPTCHA_KEY, code));
    }
}
