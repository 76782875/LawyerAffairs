    ...
    <section id="main-content">
        <section class="wrapper site-min-height">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading"> 公司纠纷类型配置</header>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal tasi-form" id="addDisputesType">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <select class="form-control" id="grade" onchange="changeGrade(this)">
                                <option value="1">一级纠纷</option>
                                <option value="2">二级纠纷</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group typeSelect" style="display: none">
                        <label class="col-sm-3 control-label">纠纷类型选择：</label>
                        <div class="col-sm-2">
            ...
            <div class="modal-footer">
                <button data-dismiss="modal" class="btn btn-default" type="button">取消</button>
                <button class="btn btn-success" type="button" onclick="addDisuptesType()">保存</button>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="edit_dialog">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal tasi-form" id="updateDisputesTypeForm">
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><span class="label_red">*</span>类型名称：</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control required" id="disputesTypeName"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><span class="label_red">*</span>排序：</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control required digits" id="disputesTypeSort"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><span class="label_red">*</span>code：</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control required digits" id="disputesTypeCode"/>
                        </div>
                    </div>
                </form>
            </div>
...
<script src="<%=basePath %>/res/pagejs/disputestype.js"></script>
</body>
</html>
