    ...
    <section id="main-content">
        <section class="wrapper site-min-height">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading"> 短信接口设置</header>
                        <div class="panel-body">
                            <div class="panel">
                                <header class="panel-heading tab-bg-dark-navy-blue ">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#tab1">阿里大于</a></li>
                                    </ul>
                                </header>
                                <div class="panel-body">
...
<script type="text/javascript" src="<%=basePath %>/res/pagejs/smsset.js"></script>
<script>
    function save() {
