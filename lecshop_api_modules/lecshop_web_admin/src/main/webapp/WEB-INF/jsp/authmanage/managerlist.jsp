                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="clearfix m-bot15" style="padding-bottom: 30px; border-bottom: solid 1px #eee;">
                                <button type="button" id="add_btn" class="btn btn-primary" onclick="addManagerBtn()"><i class="icon-plus-sign"></i> 添加</button>
            ...
            <div class="modal-body">
                <form class="form-horizontal tasi-form" id="addForm">
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control required specstr" maxlength="10" name="username">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="password" class="form-control required" maxlength="15">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><span class="label_red">*</span>角色：</label>
                        <div class="col-sm-2">
                            <select class="form-control required" id="roleList">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
            ...
            <div class="modal-body">
                <form class="form-horizontal tasi-form" id="editForm">
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><span class="label_red">*</span>用户名：</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control required" maxlength="10" name="username">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><span class="label_red">*</span>角色：</label>
                        <div class="col-sm-2">
                            <select class="form-control required" id="editRoleList">
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">是否启用：</label>
                        <div class="col-sm-2">
                            <select class="form-control required" id="editIsUse">
                                <option value="0">是</option>
                                <option value="1">否</option>
                            </select>
                        </div>
...
<script type="text/javascript" src="<%=basePath%>/res/pagejs/managerlist.js"></script>
</body>
</html>
