                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <div class="btn-group btn-group-justified list_tab" style="margin-bottom:30px">
                                ...
                                <a class="btn btn-lg btn-default btn-primary" onclick="changeTable(1)">公司事务</a>
                            ...
                            <div class="form-inline m-bot15 clearfix search-form">
                                <input type="hidden" value="${meetType}" name="meetType">
                            ...
                            <header class="panel-heading tab-bg-dark-navy-blue ">
                                <ul class="nav nav-tabs">
                                    <li><a onclick="changeTables(3,this)" style="cursor: pointer;"> 电话咨询</a></li>
                                    <li><a onclick="changeTables(2,this)" style="cursor: pointer;">预约会面</a></li>
                                    <li><a onclick="changeTables(1,this)" style="cursor: pointer;">预约会面（指定律师）</a></li>
                                </ul>
                            </header>
                            <div class="panel-body">
...
<div class="modal fade" id="confirm_dialog">
    <input type="hidden" id="confirmMeettingId"/>
    <input type="hidden" id="confirmLawyerId"/>
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">确定要确认该预约会面吗？</div>
            <div class="modal-footer">
                <button data-dismiss="modal" class="btn btn-default" type="button">取消</button>
                <button class="btn btn-success" type="button" onclick="confirmMeetting()">确定</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript" src="<%=basePath %>/res/pagejs/cappointmeet.js"></script>
</body>
</html>
