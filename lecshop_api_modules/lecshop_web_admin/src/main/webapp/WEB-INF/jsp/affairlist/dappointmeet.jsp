                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="form-inline m-bot15 clearfix search-form">
                                <input type="hidden" value="1" name="meetType">
                            ...
                            <header class="panel-heading tab-bg-dark-navy-blue ">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li><a onclick="changeTables(2)" style="cursor: pointer;">纠纷服务</a></li>
                                    <li class="active"><a onclick="changeTables(1)" style="cursor: pointer;">预约会面（指定律师）</a></li>
                                </ul>
                            </header>
                            <div class="panel-body">
...
<script type="text/javascript" src="<%=basePath %>/res/pagejs/dappointmeet.js"></script>
</body>
</html>
