                        ...
                        <div class="panel-body">
                            ...
                            <header class="panel-heading tab-bg-dark-navy-blue ">
                                <ul class="nav nav-tabs">
                                    ...
                                    <li <c:if test="${url eq 'querydraftdoc'}">class="active"</c:if>><a onclick="changeTables(1,this)" style="cursor: pointer;">草拟文书</a></li>
                                    <li <c:if test="${url eq 'querymodifydoc'}">class="active"</c:if>><a onclick="changeTables(2,this)" style="cursor: pointer;">修改文书</a></li>
                                </ul>
                            </header>
                            <div class="panel-body">
...
<form id="downForm" action="docdownload.htm">
