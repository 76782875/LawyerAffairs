...
public class ImportantMatter {
    ...
    public static ImportantMatter buildImportantMatter(ImportantMatter importantMatter, long userId, long companyId) {
        importantMatter.userId = userId;
        importantMatter.companyId = companyId;
